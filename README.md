...
**[REACT TUTORIAL]**  is an exercise to consolidate your knowledge about React, components, props, state, and hooks, by following a tutorial.
The tutorial, divided into several parts, is very comprehensive, and covers all main concepts about React, from the very basics to some intermediate topics
...
Clone this repository to your desired folder:
  ...
  cd my-folder<br>
 `git clone https://github.com/Armynerh/react_tutorial`
